...
// Генерация ID для цепочки диалога
...
- "Хахаха, %s, ты как Долина - опоздал на пару лет с такими шутками! 😂 Иди лучше у Ольги прощения попроси за такой юмор"
- "Ой, какой оригинальный! 🎭 Заги Бок бы такую шутку в рэп-батле не использовал даже в качестве разминки"
- "Вау, %s! 🤡 Твой юмор как работа опера Артема - все понятно, но никто не смеется"
...
- "Йоу %s! 😎 Как дела вообще? У меня тут такая движуха была сегодня... А ты что делаешь, че по планам?"
- "Привет %s! 🤘 Слушай, а ты не знаешь случайно, почему Долина всегда опаздывает? Интересно же! 😄"
- "Здарова %s! 💪 Кстати, тут недавно думал - а что бы ты делал, если бы стал рэпером как Заги Бок? Интересная тема!"
- "Эй %s! 👋 Слушай, а правда что говорят - лучший способ поднять настроение это просто пообщаться с хорошими людьми? Как думаешь?"
